    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li v-class="active: $route.path == '/'">
                    <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                </li>
                <li v-class="active: $route.path.indexOf('story') > 0">
                    <a href="/story/all"><i class="fa fa-fw fa-thumb-tack"></i> Stories</a>
                ...
                <li v-class="active: $route.path.indexOf('category') > 0">
                    <a href="/category/all"><i class="fa fa-fw fa-filter"></i> Categories</a>
                </li>
                <li v-class="active: $route.path.indexOf('story') > 0">
                    <a href="/keyword"><i class="fa fa-fw fa-filter"></i> Keywords</a>
                </li>
                <li>
